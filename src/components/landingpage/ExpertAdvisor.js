        ...
        >
              ...
              <Item>
                ...
                >
                  ...
                  Our expert <b>art</b> <br/> advisors
                   ...
                   <Box className="expert_caption" 
                     sx={{
                        my:{xs: 3, sm: 3, md: 5, lg: 5, xl: 5, xxl: 5}
                     }}
                   >
                    
                  <Typography variant="h6">Personalized art advisory</Typography>
                  <Typography variant="body1">We know buying art is personal. Our art advisors make it simple and seamless.</Typography>
                   <br/>
                  <Typography variant="h6">Personalized art advisory</Typography>
                  <Typography variant="body1">We know buying art is personal. Our art advisors make it simple and seamless.</Typography>
                   </Box>
          ...
          >
              <Item className="exper_right_row">
                <img src="/images/product-1.jpg" alt="expert image" />
              </Item>
              </Grid>
          </Grid>
        </Container>
